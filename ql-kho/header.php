...
<head>
    ...
    <style>
        ...
        .nav-link:hover {
            color: #fff;
            /* Thay đổi màu chữ khi di chuột qua menu */
        }
        ...
        .navbar-brand:hover {
            color: #2b4f65;
            /* Thay đổi màu chữ khi di chuột qua navbar-brand */
        }
        ...
        .navbar-nav .nav-link:hover {
            color: #2b4f65;
            /* Thay đổi màu chữ khi di chuột qua các menu item trong navbar */
        }
        ...
        .dropdown-item:hover {
            ...
            /* Thay đổi màu nền khi di chuột qua dropdown item */
            color: #2b4f65;
            /* Thay đổi màu chữ khi di chuột qua dropdown item */
        }

        .sb-topnav.navbar.navbar-expand.navbar-light.bg-primary {
            background-color: #2b4f65 !important;
            /* Thay đổi màu nền của navbar */
        }
    </style>
</head>
...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-light bg-primary">
        ...
        <a class="navbar-brand ps-3" href="index.php">Khoa hàng hành chính công</a>
